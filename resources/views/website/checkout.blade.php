            ...
            <div class="col-lg-7">
                <div class="billing-info-wrap">
                    <h3>Billing Details</h3>
                     ...
                     @if(Auth::check())
                        <h3>Bienvenu Monsieur {{ Auth::user()->name }},</h3>
                        Cliquez sur <b>Place order</b> pour valider votre commande
                    ...
                    <div class="checkout-account-toggle open-toggle2 mb-30">
                        ...
                        <input placeholder="Password" type="password" name="password" raquired>
